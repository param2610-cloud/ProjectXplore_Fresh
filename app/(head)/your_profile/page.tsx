...
const page = () => {
  ...
  return (
    <div className="flex h-full mr-2">
      ...
      <div
        id="Project_details"
        className=" flex-grow shadow-lg h-full"
      >
        <div className="flex flex-col h-full">
            ...
            <div className=" flex-grow flex p-4">
                <div className=" bg-primary/20 w-[40%] h-[250px] border-blue-400 border-4 border-dashed mx-3 flex flex-col justify-center items-center">
                    <div>
                ...
                <div className="w-[60%] h-[250px]">
                    <div>
                        <img src="5.png" alt="" className="bg-cover h-[230px] w-full rounded-md"/>
